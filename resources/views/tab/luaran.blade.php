...
<div class="content">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" id="bologna-list" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" href="#" role="tab" aria-controls="kualitas" aria-selected="true">Capaian Pembelajaran</a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="#" role="tab" aria-controls="mhs-asing" aria-selected="false">Prestasi Mahasiswa</a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="#" role="tab" aria-controls="mhs-asing" aria-selected="false">Efektivitas dan Produktivitas Pendidikan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="#" role="tab" aria-controls="mhs-asing" aria-selected="false">Daya Saing Lulusan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="#" role="tab" aria-controls="mhs-asing" aria-selected="false">Kinerja Lulusan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="#" role="tab" aria-controls="mhs-asing" aria-selected="false">Luaran Penelitian dan PkM Mahasiswa</a>
            </li>
        </ul>
    </div>
