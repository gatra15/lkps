...
<div class="content">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" id="bologna-list" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" href="#" role="tab" aria-controls="kualitas" aria-selected="true">Penelitian DTPS yang Melibatkan Mahasiswa</a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="#mhs-asing" role="tab" aria-controls="mhs-asing" aria-selected="false">Penelitian DTPS yang menjadi rujukan tema tesis/disertasi</a>
            </li>
        </ul>
    </div>
